...
async def _ocr(image_ref: str) -> str:
    """OCR via a NIM vision model. image_ref is a data URL (data:image/...;base64,...)
    or a public https image URL — both accepted by the OpenAI-compatible image_url field.
    Any failure → '' (never crash the job)."""
